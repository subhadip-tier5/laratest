...
use Ecomtracker\Semrush\Client\Exceptions\EmptyResponseException;
use Ecomtracker\Semrush\Client\Exceptions\ErroneousResponseException;
...
class ResponseParser
{
    ...
    protected function parseRow($columns, $data)
    {
        ...
        if ($expectedColumnCount != $actualColumnCount) {
            \Log::error("Number of columns in row [{$actualColumnCount}] did not equal number of expected columns [{$expectedColumnCount}]");
